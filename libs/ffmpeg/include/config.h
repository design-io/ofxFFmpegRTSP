...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86_64 --enable-yasm --enable-asm --enable-shared --disable-static"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 19.29.30139 for x64"
